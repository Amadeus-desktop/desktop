...
const variantClass: Record<ButtonVariant, string> = {
  ...
  secondary:
    "border border-[#48484f] bg-[#2c2c30] text-white hover:bg-[#35353a]",
  soft:
    "border border-[color:rgb(var(--accent-rgb)/0.25)] bg-[color:rgb(var(--accent-rgb)/0.12)] text-[color:var(--accent-soft)] hover:bg-[color:rgb(var(--accent-rgb)/0.18)]",
  ghost:
    "border border-transparent bg-transparent text-white/70 hover:bg-white/6 hover:text-white",
};
