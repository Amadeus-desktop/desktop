...
export const shellVariablesDark = {
  ...
  "--companion-paper-bg": "#252528",
  "--companion-paper-bg-deep": "#1f1f24",
  "--companion-paper-border": "rgb(var(--accent-rgb) / 0.34)",
  "--companion-paper-ink": "rgb(255 255 255 / 0.90)",
  "--companion-paper-muted": "rgb(255 255 255 / 0.54)",
  "--companion-paper-shadow": "0 18px 40px rgb(0 0 0 / 0.38), 0 0 0 1px rgb(var(--accent-rgb) / 0.12)",
  "--companion-paper-ring": "rgb(var(--accent-rgb) / 0.20)",
  "--companion-paper-highlight": "rgb(255 255 255 / 0.10)",
  "--companion-paper-accent-wash": "rgb(var(--accent-rgb) / 0.16)",
