...
pub(crate) fn llama_completion_url(endpoint: &str) -> Result<String, LlmError> {
    llama_endpoint_url(endpoint, "/completion")
}

pub(crate) fn llama_chat_completions_url(endpoint: &str) -> Result<String, LlmError> {
...
pub(crate) fn normalize_llama_content(content: String) -> Result<String, LlmError> {
