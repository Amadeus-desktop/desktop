...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            create_local_memory,
            upsert_local_personas,
            list_local_personas,
            get_local_persona,
            get_or_create_conversation_session,
            append_conversation_message,
            list_pending_conversation_messages,
            get_conversation_session_for_message,
            mark_conversation_session_synced,
            mark_conversation_message_synced,
            mark_conversation_message_sync_failed,
            upsert_cloud_conversation_message,
            list_conversation_messages_for_persona,
            enqueue_sync_payload,
            list_local_memory_cards,
            list_pending_sync_queue,
            mark_sync_queue_synced,
            record_sync_queue_failure,
